...
const ActionInfo = [
  'setFontSize',
  ['decreaseFontSize', '[', 'main', 'Reduce letter size'],
  ['increaseFontSize', ']', 'main', 'Increase letter size'],
  'setFontFamily',
  ['nextFont', 'shift+f', 'main', 'Select next font family'],
  'setLetterVSpacing',
  ['decreaseLetterVSpacing', ';', 'main', 'Deacrease vertical letter spacing'],
  ['increaseLetterVSpacing', '\'', 'main', 'Increase vertical letter spacing'],
  'setLetterHSpacing',
  ['decreaseLetterHSpacing', ',', 'main', 'Decrease horizontal letter spacing'],
  ['increaseLetterHSpacing', '.', 'main', 'Increase horizontal letter spacing'],
  'setLetterSet',
